...
exports.getDenuncia = (req, res, next) =>{
...
exports.postDenuncia = (req, res, next)=>{
    console.log(req.denunciante)
...
exports.getUmaDenuncia = (req, res, next) =>{
    mysql.getConnection((error, conn)=>{
...
exports.pathDenuncia =  (req, res, next) =>{
    mysql.getConnection((error, conn)=>{
